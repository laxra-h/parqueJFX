...
// ── OPERADORES (3 por zona) ───────────────────────────────────────
        ...
        op1.setTheAtraccion(rioSalvaje);
        op2.setTheAtraccion(tobogan);
        op3.setTheAtraccion(splashAdventure);
        ...
        op4.setTheAtraccion(carrusel);
        op5.setTheAtraccion(trenFantasia);
        op6.setTheAtraccion(miniAutos);
        ...
        op7.setTheAtraccion(montanaRusa);
        op8.setTheAtraccion(torreLibre);
        op9.setTheAtraccion(tren);
